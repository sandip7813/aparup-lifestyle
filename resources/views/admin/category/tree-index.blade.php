  ...
  <table class="table table-hover">
    <tbody>
      <tr data-widget="expandable-table" aria-expanded="false">
        <td class=" border-top-0 @if (count($category['children']) == 0) border-bottom @endif  mb-0">
          <div class="row">
            ...
            <div class="col-2">
              ...
              &nbsp;&nbsp;&nbsp;
              @endif
              <a href="{{ route('admin.category.edit', $category['uuid']) }}" data-uuid="{{ $category['uuid'] }}" data-toggle="tooltip" data-placement="top" title="Edit this category info" @if( count($category['children']) > 0 ) class="float-right" @endif><i class="fas fa-edit"></i></a>
              @if( count($category['children']) == 0 )
              &nbsp;&nbsp;&nbsp;
