                        ...
                        <tr>
                          ...
                          <td>
                            @if( $cat->blogs->count() == 0 )
                              <input type="checkbox" name="status_toggle" class="status_toggle" data-onstyle="success" data-offstyle="danger" data-on="Active" data-off="Inactive" data-size="mini" data-width="80" data-uuid="{{ $cat->uuid }}" @if($cat->status == 1) checked @endif data-toggle="toggle">
                            @else
                          ...
                          <td>
                            ...
                            @if( $cat->blogs->count() == 0 )
                              &nbsp;&nbsp;&nbsp;
                              <a href="javascript: void(0);" data-toggle="tooltip" data-placement="top" title="Delete this Category" class="delete_category" data-route="{{ route('admin.category.delete-item', $cat->uuid) }}"><i class="fas fa-trash-alt"></i></a>
                            @endif
                          </td>
                        </tr>
                      @endforeach
